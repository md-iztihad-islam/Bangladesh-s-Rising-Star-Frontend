                ...
                <div id="newsPart" className="flex flex-col justify-center items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
                        {latestNews?.map((news) => {
                            ...
                            return (
                                <a key={news._id} className="z-10 cursor-pointer w-[320px] h-[310px] border-1 rounded-md hover:shadow-lg transform hover:scale-105 duration-300 ease-in-out" href={news.newsLink || "link"} target="_blank">
                                    <figure>
