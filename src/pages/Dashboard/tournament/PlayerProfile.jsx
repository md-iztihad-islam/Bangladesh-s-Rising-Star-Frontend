...
import { useSearchPlayerWithIdQuery } from "../../../api/authApi";
...
function PlayerProfile(){
    ...
    const {data} = useSearchPlayerWithIdQuery(playerId);
        ...
        <div>
            <div className="flex flex-col justify-center items-center mt-10 mb-10 p-5">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center md:justify-between md:items-start gap-10 md:gap-30 mt-10">
                    ...
                    <div className="text-sm mdLtext-lg w-full text-wrap w-[300px]">
                ...
                <div>
                    <button onClick={() => navigate(`/admin/tournamentcontrol/addteam/${tournamentId}`)} className="mt-5 w-[150px] h-[40px] bg-gray-200 hover:bg-gray-400 rounded-md">Back</button>
                </div>
            </div>
        </div>
    );
